...
My ultimate goal is to make surveillance a holistic and rationally predictive endeavour. By publicly releasing this systematically measured pathogen phenotype data (i.e. "The Broad Viral Phenotype Collection"), I believe that this work will positively impact pathogen genomic surveillance efforts by developing the necessary workflow, data and models for rational prediction of risk. I also foresee applications in downstream research, such as drug development.
